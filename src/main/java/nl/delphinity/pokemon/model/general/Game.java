...
public class Game {
	...
	static {
		...
		GymLeader viridianLeader = new GymLeader("Gino", new Badge("Air Badge"), viridianCity);
		...
		GymLeader palletLeader = new GymLeader("Rens", new Badge("Baby Badge"), palletTown);
	...
	public static void main(String[] args) {
		...
		System.out.println("Do u want to load your last save? If yes type 'yes' otherwise type 'no'");
	...
	public static void awardBadge(String badgeName) {
		...
		System.out.println("----------------");
		System.out.println("You've recieved the: " + badgeName);
		System.out.println("----------------");
	}
	...
	private static void quit() {
		System.out.println(trainer.getPokemonCollection().size());
		serialization();
		System.exit(0);
	}
	...
	public static void deserialization() {
		try {
			FileInputStream fileIn = new FileInputStream(
					"C://Users//Gebruiker//Documents//Serialize test//PokemonGame//savedTrainer.txt");
	...
	public static void serialization() {
		File file = new File("C://Users//Gebruiker//Documents//Serialize test//PokemonGame//savedTrainer.txt");
		try {
			FileOutputStream fileOut = new FileOutputStream(file);
			ObjectOutputStream out = new ObjectOutputStream(fileOut);
			out.writeObject(trainer);
			System.out.println(
					"Geserialiseerde data is opgeslagen in C://Users//Gebruiker//Documents//Serialize test//PokemonGame//savedTrainer.txt");
		} catch (IOException i) {
			i.printStackTrace();
		}
	}
